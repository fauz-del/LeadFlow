...
router.post('/import', async (req, res) => {
  try {
    ...
    for (const b of businesses) {
      ...
      // NeDB check for existing place_id
...
function resolveNiche(category = '', name = '') {
  ...
  if (combinedText.match(/plumber|plumbers|pipes|boilers|heatings|heat|pipe|drain|heating engineer|boiler/)) return 'plumber';
  ...
  if (combinedText.match(/pet|pet|groom|pets|vet|mew|dog|cat|animal|aquarium|grooming/)) return 'petshop';
